  ...
  <div class="product-unit boxright">
    <div class="filter-container">
        <div class="filter-item">
          <el-button type="primary" @click="handleadd(0,'增加单位',true)"><i class="el-icon-circle-plus"></i> 增加单位</el-button>
        </div>
      </div>
      ...
      <el-table-column label="操作" align="center">
         <template slot-scope="scope">
          <el-button
            ...
            @click="handleditor(scope.row,'修改单位',false)"><i class="el-icon-edit"></i> 编辑</el-button>
          <el-button
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" :close-on-click-modal="false" width="550px">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="单位名称" prop="Name">
          <el-input v-model="temp.Name" placeholder="请填写单位名称"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        Name: [{ required: true, message: '单位名称必须填写！', trigger: 'blur' }]
      },
    };
  },
  created() {
    request({
      url: "ProductCompany/GetCompanyList",
      method: "get",
      params: {}
    }).then(response => {
