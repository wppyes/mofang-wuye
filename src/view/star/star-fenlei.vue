  ...
  <div class="menus boxright">
    <div class="filter-container">
        <div class="filter-item">
          <el-button type="primary" @click="handleadd('增加分类',true)"><i class="el-icon-circle-plus"></i> 增加分类</el-button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getList(){
      ...
      request({
        url: "HonourType/GetHonourTypeList",
        method: "get",
