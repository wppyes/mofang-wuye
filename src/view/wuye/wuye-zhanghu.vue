<template>
  <div class="zhanghu boxright">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
      ...
      <el-table-column label="物业名称" prop="Corporate" align="center"></el-table-column>
      <el-table-column label="小区名称" prop="CellName" align="center"></el-table-column>
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" :close-on-click-modal="false" width="550px">
      ...
      >
        ...
        <el-form-item label="物业" prop="Code">
          <el-select v-model="temp.Code" placeholder="请选择角色" @change="getuni" :disabled="temp.Id>0">
            <el-option v-for="item in wuyelist" :label="item.CellName" :key="item.Code" :value="item.Code"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        Code: [{ required: true, message: "物业必须选择！", trigger: "change" }]
      },
      total:0,
      StatusList:[]
    };
  ...
  methods: {
    ...
    getList(){      
      ...
      request({
        url: "CEmployee/GetCEmployeeList",
        method: "get",
